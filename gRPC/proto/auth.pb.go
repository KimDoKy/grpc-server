...
func (x *Verity) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Verity) ProtoMessage() {}

func (x *Verity) ProtoReflect() protoreflect.Message {
	mi := &file_gRPC_proto_auth_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Verity.ProtoReflect.Descriptor instead.
func (*Verity) Descriptor() ([]byte, []int) {
	return file_gRPC_proto_auth_proto_rawDescGZIP(), []int{1}
}

func (x *Verity) GetStatus() ResponseType {
	if x != nil {
		return x.Status
	}
...
func (x *Verity) GetAuth() *AuthData {
	if x != nil {
		return x.Auth
	}
	return nil
...
type VerifyTokenRes struct {
	...
	V *Verity `protobuf:"bytes,1,opt,name=v,proto3" json:"v,omitempty"`
}
...
func (x *VerifyTokenRes) GetV() *Verity {
	if x != nil {
		return x.V
	}
	return nil
...
var file_gRPC_proto_auth_proto_rawDesc = []byte{
	...
	0x06, 0x56, 0x65, 0x72, 0x69, 0x74, 0x79, 0x12, 0x25, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x56, 0x65, 0x72, 0x69, 0x74, 0x79, 0x52, 0x01, 0x76,
...
var file_gRPC_proto_auth_proto_depIdxs = []int32{
	0, // 0: Verity.status:type_name -> ResponseType
	1, // 1: Verity.auth:type_name -> AuthData
	1, // 2: CreateTokenReq.auth:type_name -> AuthData
	1, // 3: CreateTokenRes.auth:type_name -> AuthData
	2, // 4: VerifyTokenRes.v:type_name -> Verity
